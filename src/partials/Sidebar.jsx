...
href="#"
              ...
              {/* Community */}
              <SidebarLinkGroup activecondition={pathname.includes("staff-managment")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Finance */}
              <SidebarLinkGroup activecondition={pathname.includes("class-training")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
